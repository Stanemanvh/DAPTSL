...
out_dir="${base_experiment_dir}/${lora_type}_dino_pretrain-blk11r64_${dataset_type}-finetune_${lora_rank}_bs128"
...
torchrun --nproc_per_node=$num_gpus --master_port=40001 finetune/finetune.py \
   ...
   --model vit_base_patch14 --epochs="${epochs}" --blr="${blr}" --layer_decay 1.0 \
